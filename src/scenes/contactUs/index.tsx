    ...
    <section id="contactus" className="mx-auto w-5/6 pt-24 pb-32">
      <motion.div onViewportEnter={() => setSelectedPage(SelectedPage.ContactUs)}>
        ...
        >
          ...
          <p className="my-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque in ad delectus adipisci recusandae dolor temporibus odio, voluptates placeat necessitatibus laborum officiis libero fugit unde vitae, porro, iure ea neque!</p>
        </motion.div>
        ...
        <div className="mt-10 justify-between gap-8 md:flex">
          ...
          >
            <form target="_blank" onSubmit={onSubmit} action="https://formsubmit.co/e3a11ff0dd47d1489e66a4c88f48f91b" method="POST">
              {/* NAME */}
